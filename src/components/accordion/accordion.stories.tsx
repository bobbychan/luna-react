...
import { Accordion, AccordionItem, AccordionItemProps, AccordionProps } from '.';
...
const CustomInidicatorTemplate = (args: AccordionProps) => (
  <Accordion {...args}>
    ...
    <AccordionItem
      key="moon"
      aria-label="Moon"
      indicator={<MoonIcon className="w-6 h-6" />}
      title="Moon"
    >
      {defaultContent}
    </AccordionItem>
    <AccordionItem
      key="sun"
      aria-label="Sun"
      indicator={<SunIcon className="w-6 h-6" />}
      title="Sun"
    >
      {defaultContent}
    </AccordionItem>
  ...
  return (
    ...
    >
      <AccordionItem
        ...
        startContent={<InformationCircleIcon className="text-primary w-6 h-6" />}
        subtitle={
          <p className="flex">
            2 issues to&nbsp;<p className="text-primary">fix now</p>
          </p>
      ...
      <AccordionItem
        ...
        startContent={<InformationCircleIcon className="text-warning w-6 h-6" />}
      ...
      <AccordionItem
        ...
        startContent={<InformationCircleIcon className="text-danger w-6 h-6" />}
