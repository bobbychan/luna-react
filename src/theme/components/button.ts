...
const button = tv({
  ...
  variants: {
    ...
    size: {
      sm: 'px-3 min-w-[4rem] h-8 text-xs gap-2 rounded-small',
      md: 'px-4 min-w-[5rem] h-10 text-sm gap-2 rounded-medium',
      lg: 'px-6 min-w-[6rem] h-12 text-base gap-3 rounded-large',
    },
    color: {
      default: '',
      primary: '',
